...
public class ClaimHandlerServiceComponent {
    private static Log log = LogFactory.getLog(ClaimHandlerServiceComponent.class);
    ...
    protected void setRealmService(RealmService realmService) {
        ClaimHandlerServiceComponent.realmService = realmService;
        if (log.isDebugEnabled()) {
    ...
    protected void unsetRealmService(RealmService realmService) {
        ClaimHandlerServiceComponent.realmService = null;
        if (log.isDebugEnabled()) {
    ...
    public static RealmService getRealmService() {
        return ClaimHandlerServiceComponent.realmService;
    }
